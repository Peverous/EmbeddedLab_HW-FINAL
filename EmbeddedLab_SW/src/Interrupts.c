...
*
****************************************************************************/
int SetupInterruptSystem(XUartLite *UartLitePtr_1, u8 UartLite_1_Id, XUartLite *UartLitePtr_2, u8 UartLite_2_Id, XTmrCtr* TmrCtrInstancePtr, u8 Timer_Id,XTmrCtr* TmrCtrInstancePtr_1, u8 Timer_Id_1)
{
	int Status;
	...
	Status = XIntc_Connect(&InterruptController, Timer_Id_1, (XInterruptHandler)XTmrCtr_InterruptHandler, (void *)TmrCtrInstancePtr_1);
		if (Status != XST_SUCCESS) {
			return XST_FAILURE;
		}
	...
	XIntc_Enable(&InterruptController, Timer_Id_1);
	/*
